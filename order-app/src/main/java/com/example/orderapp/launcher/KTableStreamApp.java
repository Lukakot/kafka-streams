...
import com.example.orderapp.topology.KTableTopology;
...
import static com.example.orderapp.topology.KTableTopology.WORDS;
...
public class KTableStreamApp {
    ...
    public static void main(String[] args) {
        ...
        var kTableTopology = KTableTopology.build();
